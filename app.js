...
// You can use a static year value to solve problems 6 and 7. As a small level up opportunity, check out how to dynamically get today’s year using the Date() constructor.
/*
...
travelMethodCounts = travelMethods.reduce((counts, travelMethod) => {
  if (counts[travelMethod])
    counts[travelMethod] += 1
  else
    counts[travelMethod] = 1
  return counts
}, {})
